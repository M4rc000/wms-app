...
<div class="modal fade" id="addModal" tabindex="-1">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<?= form_open_multipart('master/AddWIP'); ?>
			<div class="modal-header">
				<h5 class="modal-title">Add WIP</h5>
...
<?php foreach ($submenus as $sb) : ?>
	<div class="modal fade" id="editModal<?= $sb['Id']; ?>" tabindex="-1">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<?= form_open_multipart('adminhead/EditWIP'); ?>
				<div class="modal-header">
					<h5 class="modal-title">Edit WIP</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<!-- GET USER ID -->
...
<?php foreach ($submenus as $sb) : ?>
	<?= form_open_multipart('adminhead/DeleteWIP'); ?>
